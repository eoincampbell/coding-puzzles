namespace AdventOfCode2019.Puzzles.Day04
{
    ...
    {
        public Impl2() : base("Day 04b: Secure Container", ".\\Puzzles\\Day04\\Input.txt") { }
        ...
        {
            return GetRange2(Inputs[0], Inputs[1]).Count(x => checkFunc(x.ToString()));
        }
        ...
        public IEnumerable<int> GetRange2(int s, int e)
        {
            while (s < e)
            {
                var ss = s.ToString();
