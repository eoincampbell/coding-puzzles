...
namespace AdventOfCode2019.Puzzles.Day12
{
    ...
    public class Impl2 : Puzzle<string, long>
    {
        ...
        private MoonB[] GetMoons()
            => new[] {new MoonB(Inputs[0]), new MoonB(Inputs[1]), new MoonB(Inputs[2]), new MoonB(Inputs[3])};
